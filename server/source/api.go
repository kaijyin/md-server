...
var apis = []context.SysApi{
	...
	{global.GVA_MODEL{ID: 9, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/control/createAuthority", "创建角色", "control", "POST"},
	{global.GVA_MODEL{ID: 10, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/control/deleteAuthority", "删除角色", "control", "POST"},
	{global.GVA_MODEL{ID: 11, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/control/getAuthorityList", "获取角色列表", "control", "POST"},
	...
	{global.GVA_MODEL{ID: 31, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/control/setDataAuthority", "设置角色资源权限", "control", "POST"},
	...
	{global.GVA_MODEL{ID: 41, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/control/updateAuthority", "更新角色信息", "control", "PUT"},
	{global.GVA_MODEL{ID: 42, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/control/copyAuthority", "拷贝角色", "control", "POST"},
...
func (a *api) Init() error {
	return global.GVA_DB.Transaction(func(tx *gorm.DB) error {
		if tx.Where("id IN ?", []int{1, 67}).Find(&[]context.SysApi{}).RowsAffected == 2 {
